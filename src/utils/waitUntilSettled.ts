import { sleep } from "@figedi/svc";
import { TimeoutExceededError, UnknownStreamIdError } from "../errors";
import { IEventStore } from "../infrastructure/types";

export const createWaitUntilSettled = (eventStore: IEventStore) => async (
  streamIds: string[],
  timeoutMs = 5000,
  stepMs = 100,
) => {
